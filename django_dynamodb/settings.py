"""
Django settings for django_dynamodb project.
...
SECRET_KEY = 'django-insecure-t2ao9*s6r1ult+%ra)rt!94m4*otzgp3+vaq(qymu$d!imqc1j'
...
ROOT_URLCONF = 'django_dynamodb.urls'
...
WSGI_APPLICATION = 'django_dynamodb.wsgi.application'
